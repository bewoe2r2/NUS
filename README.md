...
├── tests/                      # HMM validation tests
├── video/                      # Remotion pitch video (4K)
├── website-v2/                 # Next.js pitch website
...
The API will be available at `http://localhost:8000` with interactive docs at `http://localhost:8000/docs` (Swagger UI auto-generated by FastAPI).
...
Open `http://localhost:3000` for the patient/nurse/judge dashboards.
...
cd video
npm install
npx remotion render src/Root.tsx BewoVideo out/bewo-4k.mp4 --codec h264 --concurrency 4
```
