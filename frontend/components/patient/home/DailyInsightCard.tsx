        ...
        >
            ...
            <div className="flex justify-between items-start mb-4">
                <div className="flex items-center gap-2">
                    ...
                    <div>
                        <div className="text-xs uppercase font-bold tracking-widest opacity-60">Bewo AI</div>
                        <div className="font-bold text-xl leading-tight">{config.greeting}</div>
                    </div>
                </div>

                <div className={cn("px-3 py-1.5 rounded-full text-sm font-bold shadow-sm flex items-center gap-1.5", config.badge)}>
            ...
            {/* Main Message */}
            <p className={cn("text-lg font-medium mb-6 leading-relaxed", isStable ? "text-neutral-700" : config.text)}>
                "{config.message}"
            </p>
            ...
            <div className="grid grid-cols-3 gap-2 py-4 bg-white/40 backdrop-blur-md rounded-2xl border border-white/50 shadow-inner">
                ...
                <div className="flex flex-col items-center justify-center p-2 border-r border-neutral-200/50">
                    <span className="text-xs uppercase font-bold text-neutral-500 mb-1">Merlion Risk</span>
                ...
                {/* 2. Trend */}
                <div className="flex flex-col items-center justify-center p-2 border-r border-neutral-200/50">
                    <span className="text-xs uppercase font-bold text-neutral-500 mb-1">Trend (48h)</span>
                    <div className="flex items-center gap-1">
                        ...
                        <span className="text-base font-semibold text-neutral-700 capitalize">{trend.toLowerCase()}</span>
                    </div>
                </div>

                {/* 3. Volatility derived from HMM state */}
                <div className="flex flex-col items-center justify-center p-2">
                    <span className="text-xs uppercase font-bold text-neutral-500 mb-1">Volatility</span>
            ...
            <div className="mt-4 flex items-center gap-2 text-sm text-neutral-500 italic">
