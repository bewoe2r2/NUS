...
export function GuidedWalkthrough({ onClose, onTabChange, onRefresh, onStepChange, initialStep }: GuidedWalkthroughProps) {
    ...
    const steps: WalkthroughStep[] = [
        ...
        // ===============================================
        {
            ...
            insight: "This is where Bewo saves lives. Traditional alerts fire when ONE metric crosses a line (glucose > 11). Bewo detects when the PATTERN across ALL metrics shifts — even when no single metric looks alarming. That's 48 hours of early warning that no other system provides.",
            tab: "overview",
        ...
        // ===============================================
        {
            ...
            insight: "Built for Singapore (Singlish, hawker food, NTUC vouchers). Designed for ASEAN's 56M diabetics. Clinically rigorous (HMM, SBAR, pharmacovigilance). Eligible for the $5,000 NMLP Special Award — SEA-LION v4 27B + MERaLiON integration demonstrates real-world use of AI Singapore's models for culturally-adapted healthcare.",
            icon: <Sparkles size={20} />,
