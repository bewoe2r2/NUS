        ...
        },
        {
            ...
            action: async () => {
                try {
                    ...
                    setChatDemoResult({
                        message: "Uncle, you doing okay lah! Your sugar level stable, medication on track. Keep it up — walk a bit more today can?",
                        actions: [{ tool: "get_health_summary" }, { tool: "check_medication_adherence" }],
                    });
                }
            },
